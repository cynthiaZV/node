...
Aroma.Engine = function(e) {
    ...
    this.startEff = function() {
        ...
        var e = [],
            ...
            u = null;
        for (var a = 0,
                 f = this._selector.getCount(); a < f; ++a) {
...
Aroma.Engine.prototype.removeTweens = function() {
    for (var e = 0,
             t = this._tweenList.length; e < t; e++) {
...
Aroma.AbstractView = function(e, t) {
    ...
    this.sortInCols = function() {
        ...
        for (var t = this._pieceList.length,
                 n = e; n < t; n += this.col) {
...
Aroma.AbstractView.prototype.dispose = function() {
    for (var e = 0,
             t = this._pieceList.length; e < t; ++e) {
...
Aroma.RandSelector.prototype.setup = function(e, t) {
    ...
    for (var n = 0,
             r = t.col * t.row; n < r; ++n) this.id_rand_list[n] = n
};
...
Cute.Effect12.prototype.getPieceOptions = function() {
    ...
    function e(e) {
        for (var t = 0,
                 n = window.resizeListeners.length; t < n; ++t) {
...
Cute.Ticker = Cute.Ticker || {
        ...
        remove: function(e, t) {
            for (var n = 0,
                     r = Cute.Ticker.list.length; n < r; ++n) {
...
Cute.ModuleLoader.css3d_files = ["http://weiyou.app-h5.com/images/js/cute.css3d.module.js"];
...
Averta.EventDispatcher.extend = function(e) {
    ...
    for (var n in t) if (n != "constructor") e[n] = Averta.EventDispatcher.prototype[n]
};
Averta.EventDispatcher.prototype = {
    ...
    removeEventListener: function(e, t, n) {
        if (this.listener[e.type]) {
            for (var r = 0,
                     i = this.listeners[e].length; r < i; ++r) if (t == this.listeners[e][r].listener && n == this.listeners[e][r].ref) this.listeners[e].splice(r);
            if (this.listeners[e].length == 0) delete this.listeners[e]
        }
    },
    dispatchEvent: function(e) {
        e.target = this;
        if (this.listeners[e.type]) for (var t = 0,
                                             n = this.listeners[e.type].length; t < n; ++t) {
...
Cute.SlideControl.prototype.setup = function(e) {
    ...
    var t;
    for (var n = 0,
             r = this.slider.getSlideList().length; n < r; ++n) {
...
Cute.Captions.prototype.show = function() {
    ...
    if (this.data) {
        for (var n = 0,
                 r = this.captions[this.slide_index].length; n < r; ++n) {
...
Cute.Captions.prototype.hide = function() {
    if (this.captions[this.slide_index]) {
        for (var e = 0,
                 t = this.captions[this.slide_index].length; e < t; ++e) {
...
Cute.Slider.prototype = {
    ...
    __setSize: function() {
        ...
        this.slideManager.height = this.wrapper.clientWidth / this.aspect +300;
        //this.slideManager.height = (window.outerHeight-90)+"px";
        ...
        //this.slideManager.vpHeight = (window.outerHeight-100)+"px";
        console.info( this.slideManager.height  +"             "+this.slideManager.vpHeight);
        this.element.style.width = this.slideManager.width + "px";
        //this.element.style.height = this.slideManager.height + "px"
        this.element.style.height = (window.outerHeight-100)+"px";
    },
    __onresize: function() {
        this.__setSize();
        this.slideManager.resize()
